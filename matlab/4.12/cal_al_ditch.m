function[all_ditch]=cal_ditch_r2r3(lamdaf1,lamdaf2,betaf1,K,alpha,cs_ratio,a,rtt,ttl,Ni)
...
legal_interestlayer1=legal_interest_r1_f1+legal_interestr1_f2;
%-第一层命中率
...
%     illegal_interestlayer2r3(rank)=illegal_interestlayer1(rank)*(1-(1-betaf1)*exp(-a*(rank-1)));
  ...
  legal_interest_r2=legal_interest_r1_f1(rank)*(1-hit_ratior1(rank))*(1-betaf1)*exp(-a*(rank-1))+legal_interest_r1_f2(rank)*(1-hit_ratior1(rank))*(1-betaf2)*exp(-a*(rank-1));
   
  legal_interest_r3=legal_interest_r1_f1(rank)*(1-hit_ratior1(rank))*(1-(1-betaf1)*exp(-a*(rank-1)))+legal_interest_r1_f2(rank)*(1-hit_ratior1(rank))*(1-(1-betaf2)*exp(-a*(rank-1)));
  
  illegal_interest_r2=illegal_interest_r1_f1(rank)*(1-betaf1)*exp(-a*(rank-1));
  
  illegal_interest_r3=illegal_interest_r1_f1(rank)*(1-(1-betaf1)*exp(-a*(rank-1)));
...
ditchr2=cal_ditch_ratio_2_parts(legal_interest_r2,illegal_interest_r2,cs_ratio,rtt,ttl,Ni);


ditchr3=cal_ditch_ratio_2_parts(legal_interest_r3,illegal_interest_r3,cs_ratio,rtt,ttl,Ni);
