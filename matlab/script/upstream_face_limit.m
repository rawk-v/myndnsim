function[ditch_r1,ditch_2layer,illegal_interest_ratio]=upstream_face_limit(lamdaf1,lamdaf2,betaf1,K,alpha,cs_ratio,a,rtt,ttl,Ni,ditch_r2,ditch_r3)


interest_ratio_layer1=cal_interest_ratio(K,alpha);


lamdaf1=lamdaf1*(1-betaf1)/(2-betaf1);





lamdaf2=lamdaf2/(2-betaf1);
...
limit_ratio_to_r2=lamda_ratio_r2*(1-ditch_r2);
limit_ratio_to_r3=(1-lamda_ratio_r2)*(1-ditch_r3);


legal_interest_r2=limit_ratio_to_r2*legal_interest_r2;
legal_interest_r3=limit_ratio_to_r3*legal_interest_r3;




illegal_interest_r2=limit_ratio_to_r2*illegal_interest_r2;
illegal_interest_r3=limit_ratio_to_r3*illegal_interest_r3;
...
% 
% limit_ratio_to_r2=1-sum(illegal_interest_r2)/sum(legal_interest_r2+illegal_interest_r2);
% limit_ratio_to_r3=1-sum(illegal_interest_r3)/sum(legal_interest_r3+illegal_interest_r3);
% 
% 
