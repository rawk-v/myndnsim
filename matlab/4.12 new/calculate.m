...
x=1;
y=1;
% for a_current=0:0.1:1;
%  
%   [all_ditch(x),ditchr2(x),ditchr3(x)]=cal_ditch_r2r3(lamda,lamda,betaf1,50,1.2,cs_ratio,a_current,tRtt,tTtl,Ni);
%   
%   a(x)=a_current;
%   x=x+1;
% end
...
for a1_current=0:0.01:0.3
    x=1;
    for a2_current=0:0.01:0.3
