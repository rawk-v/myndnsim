...
% legal_interest_1_layer(1:K)=0;
% 
% legal_interest(1,:)=legal_interest_1_layer;
% illegal_interest(1,:)=illegal_interest_1_layer;




legal_interest1layer(1:K)=0;
illegal_interest1layer(1:K)=0;

ditch1;
legal_interest2layer=legal_interest1layer*(1-hit)*(1-ditch1);
illegal_interest2layer=illegal_interest1layer*(1-ditch1);
...
lamda_first_layer=lamda*interest_ratio1;
...
for layer_current=1:layer
    ...
    ditch_uplayer(layer_current)=cal_ditch(K,m,cs_ratio,chunck,alpha,interest,beta,tRtt,tTtl,Ni);
end
